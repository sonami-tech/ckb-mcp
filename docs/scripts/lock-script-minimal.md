...
For understanding how lock scripts relate to addresses and the complete cryptographic transformation chain, see the [Lock Value Relationships](ckb://docs/concepts/lock-values) guide.