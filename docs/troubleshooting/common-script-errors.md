...
**Reference**: See the [Granular Error Code Pattern](ckb://docs/patterns/rust-script-development-patterns#granular-error-code-pattern) for detailed implementation examples and best practices.
