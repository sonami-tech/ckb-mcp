...
impl DocsProvider {
	...
	fn load_built_in_docs(&mut self) -> Result<()> {
		...
		let resource_mappings = [
			...
			("ckb-dev-context://patterns/c-to-rust-migration-guide", "patterns/c-to-rust-migration-guide.md"),
			...
			("ckb-dev-context://patterns/development-tools-guide", "patterns/development-tools-guide.md"),
			...
			("ckb-dev-context://patterns/minimal-lock-script-pattern", "patterns/minimal-lock-script-pattern.md"),
			("ckb-dev-context://patterns/minimal-type-script-pattern", "patterns/minimal-type-script-pattern.md"),
			...
			("ckb-dev-context://patterns/omnilock-interoperability-guide", "patterns/omnilock-interoperability-guide.md"),
			("ckb-dev-context://patterns/operation-detection-pattern", "patterns/operation-detection-pattern.md"),
			...
			("ckb-dev-context://patterns/simple-transfer-guide", "patterns/simple-transfer-guide.md"),
			...
			("ckb-dev-context://patterns/token-creation-guide", "patterns/token-creation-guide.md"),
			...
			("ckb-dev-context://patterns/udt-tokens-guide", "patterns/udt-tokens-guide.md"),
			("ckb-dev-context://patterns/cobuild-integration-guide", "patterns/cobuild-integration-guide.md"),
			("ckb-dev-context://patterns/ssri-implementation-guide", "patterns/ssri-implementation-guide.md"),
