...
1. Access ckb://docs/quickstart/getting-started to understand the current recommended stack.
...
5. Reference ckb://docs/tools/development-tools for best practices.
...
2. Reference ckb://docs/quickstart/getting-started to identify outdated components.
...
6. Reference ckb://docs/scripts/patterns for current best practices.
...
1. Reference ckb://docs/scripts/lock-script-minimal or ckb://docs/scripts/type-script-minimal as appropriate.
...
4. Include comprehensive testing patterns from ckb://docs/scripts/patterns.
...
1. Access relevant documentation from ckb://docs/scripts/patterns.
2. Show advanced Rust patterns for this functionality.
3. Reference ckb://docs/scripts/system-scripts for core concepts.
...
7. Reference ckb://docs/scripts/system-scripts for security patterns.
...
1. Reference ckb://docs/transactions/building-patterns for modern approaches.
...
1. Access ckb://docs/transactions/building-patterns for advanced patterns.
...
6. Reference ckb://docs/sdk/rust-sdk-advanced for SDK usage.
...
1. Reference ckb://docs/quickstart/getting-started for CCC setup.
...
6. Reference ckb://docs/dao/patterns-basic for DAO integration.
...
1. Reference ckb://docs/omnilock/protocol for protocol details.
2. Access ckb://docs/omnilock/development for implementation patterns.
3. Show how to support Ethereum, Bitcoin, and other wallet types.
4. Include ckb://docs/omnilock/api-examples for specific usage.
...
1. Reference ckb://docs/spore/protocol or ckb://docs/cota/protocol.
...
1. Reference ckb://docs/dao/patterns-basic for comprehensive guidance.
...
7. Reference ckb://docs/scripts/system-scripts for core DAO logic.
...
2. Access ckb://docs/concepts/cell-model for advanced patterns (script execution, optimization, shared state).
...
7. Reference ckb://docs/scripts/patterns for relevant implementation patterns.
...
6. Reference ckb://docs/scripts/operation-detection for state tracking.
...
5. Reference ckb://docs/scripts/system-scripts for optimization techniques.
...
6. Reference ckb://docs/scripts/system-scripts for validation logic.
...
5. Reference ckb://docs/scripts/patterns for best practices.
...
1. Reference ckb://docs/tools/binary-deployment for deployment patterns.
...
6. Reference ckb://docs/tools/development-tools for tooling.
...
1. Reference testing patterns from ckb://docs/scripts/patterns.
...
6. Reference ckb://docs/scripts/system-scripts for test examples.
